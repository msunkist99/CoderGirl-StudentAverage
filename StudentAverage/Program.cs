...
namespace StudentAverage
{
    public static class Program
    {
        public static void Main()
        {
            ...
            string[] studentsText = File.ReadAllLines(@"C:\Users\msunk\Documents\CoderGirlLC101\Lesson09 CoderGirl-StudentAverage\CoderGirl-StudentAverage\studentdata.txt");
